...
DEFAULT_PROMPT_FALLBACK="Deep scan and fix all issues; keep investigating for bugs and inconsistencies. Make sure its all correct and genuiune. Investigate, explore, debug and fix all issues. We shouldnt have to force or fudge it, actually if you understand TEP properly it should all fall into place quite simply. Ensure consistency with wider corpus @manuscripts."
