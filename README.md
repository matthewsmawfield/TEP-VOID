...
[![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.22150140.svg)](https://doi.org/10.5281/zenodo.22150140)
...
**Date:** First published: 29 August 2026 · Last updated: 29 August 2026  
**Status:** Preprint (Draft)  
**DOI:** [10.5281/zenodo.22150140](https://doi.org/10.5281/zenodo.22150140)  
...
2. **Calibration-independent relative evolution**: $R_H = 1.0066 \pm 0.0064$, $7.7\sigma$ from the KBC Gaussian prediction ($R_H = 0.9569$) and $8.9\sigma$ from the Exponential, with KBC predictions evaluated through the matched GLS estimator. The common zero-point cancels; the test is independent of the Cepheid calibration.
...
5. **Preliminary $X_i$-step test**: $-12.1 \pm 8.7$ mmag ($1.39\sigma$) in the TEP-predicted direction on 1,470 Pantheon+ SNe, not yet significant with the Tully-Fisher $V_{\rm rot}$ proxy.
...
| **Paper 31** | **TEP-VOID** (This repo) | Cosmological Voids vs Temporal Shear | [10.5281/zenodo.22150140](https://doi.org/10.5281/zenodo.22150140) |

## Pipeline Structure

The pipeline (21 steps) falsifies the void model and tests the two-channel
TEP calibration framework. Five additional standalone steps (32c, 32b-proper,
44, 45, 46) provide supplementary analyses referenced in the manuscript.
...
├── 31-TEP-VOID-v0.1-Valencia.md   # Generated manuscript (built from site/components)
...
The built site will be in `site/dist/`. The build also regenerates `31-TEP-VOID-v0.1-Valencia.md` at the repository root.
