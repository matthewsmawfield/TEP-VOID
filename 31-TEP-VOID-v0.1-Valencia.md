...
A rigorous derivation of this drift requires modeling the non-radial $g_{0i}$ structure induced by orbital motion, which is deferred to future work. The synchronization holonomy transport factor is therefore parameterized with an $\mathcal{O}(1)$ transport efficiency coefficient $\eta_P$:
